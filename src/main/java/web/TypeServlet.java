...
@WebServlet(name = "typServ", urlPatterns = { "/types", "/saisieType", "/saveType", "/supprimerTyp", "/editerTyp",
		"/updateTyp" })
...
public class TypeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
...

		{
			...
			/*try {
				datetyp =simpleDateFormat.parse(request.getParameter("datetyp"));
			...
			try {
				...
				dateTyp =simpleDateFormat.parse(request.getParameter("dateCreation"));
